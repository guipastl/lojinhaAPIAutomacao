...
public class ProdutoTest {
    ...
    public void testValidarLimitesZeradoProibidosValorProduto() {
        // Tentar inserir um produto com valor 0.00 e validar que a mensagem de erro foi apreentada e o
        // status code retornado foi 422
        given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
                .body(ProdutoDataFactory.criarProdutoComumComOCalorIgualA(0.00))
            .when()
                .post("/v2/produtos")
            .then()
                .assertThat()
    ...
    public void testValidarLimitesMaiorSeteMilProibidosValorProduto() {
        // Tentar inserir um produto com valor 7000.01 e validar que a mensagem de erro foi apreentada e o
        // status code retornado foi 422

        given()
                .contentType(ContentType.JSON)
                .header("token", this.token)
                .body(ProdutoDataFactory.criarProdutoComumComOCalorIgualA(7000.01))
             .when()
                .post("/v2/produtos")
            .then()
                .assertThat()
